console.log("-->FUNCTIONS 2a HOMEWORK<--");
////////// PROBLEM 1 //////////
...
console.log('Problem 1: Scroll up to see the question.')
////////// PROBLEM 2 //////////
/*
...
// CODE HERE
let logParams = (param1, param2) => `Problem 2: The first parameter is ${param1}. The second parameter is ${param2}.`;

// INVOKE AND CONSOLE LOG THE FUNCTION HERE. THE PARAMETERS TAKE ANY DATATYPE.
console.log(logParams('Hello', 'World'));
...
// CODE HERE
// 'pricesPlusTax' function
function pricesPlusTax(prices, callback) {
    for (let price of prices) {
      let total = price + (price * 0.20);
...
// CODE HERE
// Invoking 'pricesPlusTax' function
pricesPlusTax(prices, function(totalCost) {
   console.log(`Problem 4: The new array plus tax = ${totalCost}`);
});
...
// CODE HERE
// 'multiplyingFactory' function
function multiplyingFactory(num1) {
    return function(num2) {
      if (num1 >= 5) {
        console.log(`Problem 5: The multiplication of ${num1} and ${num2} is `, (num1 * num2));
      } else {
        console.log("Problem 5: I will only calculate a number that is greater than or equal to 5.");
      }
    }
  }
...
// CODE HERE
// Saving returned function into 'timesFour'
...
*/
timesFour = multiplyingFactory(3);
  timesFour(4);