...
//CODE HERE
function helloWorld() {
  console.log('Hello, world!') // no semicolon following the console.log statement in a function.
};
helloWorld();
...
//CODE HERE
const printName = (personsName) => `Hello, ${personsName}`
console.log(printName('Ryan'));
////////////////// PROBLEM 4 ////////////////////
/*
...
//CODE HERE
const greeting = (anyName) => `Hello, ${anyName}`
console.log(greeting('Tony the Tiger'));
...
const compareNums = (firstNum, secondNum) => {
  if(firstNum > secondNum) {
    ...
    console.log(`${firstNum} and ${secondNum} are the same value.`)
}
...
console.log(exclaimThree('darkness, is merely the absence of light.'));
...
function faveColorFinder(color){
  if(color === 'red'){
    ...
    console.log(`${color}?, you need to evaluate your favorite color.`);
}
...
//CODE HERE
const bestMovie = (nameOfMovie) => {console.log(`${nameOfMovie} is the best movie ever!`)};

bestMovie('Lonesome Dove');
...
////////////////// PROBLEM 17 ////////////////////
let sampleString = "Hi, my name is Ryan Smith."
/*
...
console.log(emailCheck('thisisfake email'));
...
//CODE HERE
function calculateFrogs(gold) {
  return (gold / 3); // Math.floor prevents returning a decimal by rounding down
}

let totalFrogs = calculateFrogs(4);
...
//CODE HERE
function calculateFrogs2(gold){
 return Math.floor(gold / 3);
}

let totalFrogs2 = calculateFrogs2(2)
...
//CODE HERE
function checkArrayAscending(someArray){
  let checkValue = someArray[0];
  for(let i = 1; i < someArray.length - 1; i++){
    if(someArray[i] <= checkValue){
      return false;
    }else {
      checkValue = someArray[i];
    }
  }
  return true;
}
...
let arrayIsAscending1 = checkArrayAscending(sampleArray1);
...
let bathroomScope = ['duck', 'rubbberDuck']
